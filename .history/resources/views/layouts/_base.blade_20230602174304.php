                ...
                <div class="w-1/4 md:w-2/6 font-light mb-5">
                    ...
                    <div class="bg-white rounded-lg overflow-hidden border border-neutral-200">
                        <div class="border-b border-neutral-200">
                            <div class="text-sky-900 font-semibold uppercase py-5 px-5">
                              <svg xmlns="http://www.w3.org/2000/svg" class="inline ml-2 stroke-current" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                <path stroke="#323232" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 18a4 4 0 0 1 4-4h4a4 4 0 0 1 4 4m1-13.349a2.5 2.5 0 1 1 0 5m-4.595-4.655a3.401 3.401 0 1 1-4.81 4.81 3.401 3.401 0 0 1 4.81-4.81M17 13a4 4 0 0 1 4 4"/>
                              </svg>
                                مدیریت طرف حساب ها
                            </div>
                        </div>
                    ...
                    <div class="mt-5 bg-white rounded-lg overflow-hidden border border-neutral-200">
                        <div class="border-b border-neutral-200">
                            <div class="text-sky-900 font-semibold uppercase py-5 px-5">مدیریت محصولات</div>
                        </div>
                        <div>
                            <a class="block py-3 px-5 hover:bg-neutral-100" href="#">
                                <div class="text-neutral-700 text-sm">
