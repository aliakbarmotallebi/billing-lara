                ...
                <div class="flex items-center justify-between py-4 pl-1">
                    ...
                    <div class="hidden sm:flex items-center">
                        <div class="relative" id="usermenu">
                            <div
                                class="flex items-center cursor-pointer text-sm border border-white border-b-0 text-gray-700 rounded-t-lg py-1 px-2">
            ...
            <div class="flex w-full min-w-full rounded-sm mt-4">
                ...
                <div class="w-1/4 md:w-2/6 font-light mb-5">
                    ...
                    <div class="bg-white rounded">
                        ...
                        <div>
                            <a class="block py-3 px-5 border border-gray-200 bg-gray-600 flex justify-between"
                                href="#">
                    ...
                    <div class="mt-5 bg-white rounded">
                        <div class="border-b border-gray-200">
                            <div class="text-black font-light uppercase text-sm py-5 px-5">مدیریت محصولات</div>
                        </div>
                        <div>
                            <a class="block py-3 px-5" href="#">
                                <div class="text-gray-700">
