                    ...
                    <div>
                        <a href="#" class="flex items-center font-extrabold text-gray-700 text-sm">
                          ...
                          <div class="text-lg font-semibold mr-5">
                            ...
                            <div class="text-xs text-gray-200 mt-3 ">
                              یک سیستم جامع برای حسابداران و مدیران مالی می باشد دسترسی آسان در هر ساعت از شبانه روز به اطلاعات و اسناد حسابداری مانند: فاکتورها، تراکنش ها
                            </div>
                          </div>
                        </a>
                    </div>
